...
class CardFile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        Toast.show("Este pdf foi salvo no seu dispositivo.", context,
        ...
        try {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => AttendanceDocScreen(file.path)),
          );
        } catch (e) {
          Toast.show("Não foi possível exibir este pdf.", context,
              duration: Toast.LENGTH_LONG);
        }
      },
      child: ListTile(
