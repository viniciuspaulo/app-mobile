        ...
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                child: this.attendance.rating == null
                  ...
                  children: [
                      ...
                      child: Row(
                          ...
                          children: [
                            this.attendance.logo != null
                                ...
                                : Text(""),
                            Text(this.attendance.farmaciaName != null
                                ? this.attendance.farmaciaName
                                : "")
                          ]),
                    ),
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          this.attendance.farmaciaPhone != null
                              ? this.attendance.farmaciaPhone
                              : "",
                          style: TextStyle(
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(attendance.farmaceutico != null
                            ? attendance.farmaceutico
                            : ""),
                        trailing: Column(
                          children: [
                    ...
                    Column(
                      children: attendance.procedures != null
                          ? attendance.procedures.map((procedure) {
                    ...
                    Container(
                      ...
                      child: Card(
                        color: Colors.white,
                        child: Column(
                          children: attendance.files != null
                              ? attendance.files.map((file) {
